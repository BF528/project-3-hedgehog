...
OUT=/projectnb/bf528/users/hedgehog/project_3/project-3-hedgehog/Programmer/countsfile.txt

###Location of Hedgehog BAM files##
BAMFILE=/projectnb/bf528/users/hedgehog/project_3/data_curator_data/bam_files/*.bam
